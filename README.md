...
1. Install the ESP32-A2DP Library in the Arduino IDE. You can find it [here](
2. Install the M5Stack Library in the Arduino IDE. You can find it [here](
3. Connect the M5Stack RCA Module to the M5Stack Basic.
4. Open the Arduino IDE and create a new sketch.
5. Copy and paste the code from the `ESP32_BT-A2DP_Receiver.ino` file into the new sketch.
6. Upload the sketch to your M5Stack Basic.
7. Open the Serial Monitor to see the debug output.
8. Pair your device with the ESP32 and start playing audio.

## Usage

1. Ensure the ESP32 is properly connected to the M5Stack Basic and the RCA Module.
2. Power on the M5Stack Basic.
3. Pair your Bluetooth device (e.g., smartphone, laptop) with the ESP32.
...
- Thanks to the developers of the ESP32-A2DP Library for making Bluetooth audio streaming possible.
